    ...
    stages{
        ...
        stage ('OSS Scan') {
            steps {
                ...
                wget -Oc https://download.sonatype.com/clm/scanner/latest.jar > /Nexus/latest.jar
                java -jar /Nexus/latest.jar -a "${IQ_User}":"${IQ_Key}" -D includeNpmDependencies -s $Sonatype_IQ_Server -i $Sonatype_App_Name -t stage-release ./
                '''
                }
            }
        }
